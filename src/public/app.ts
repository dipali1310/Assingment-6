...
class App {
  ...
  editUser(event: Event) {
    ...
    const saveBtn = row.getElementsByClassName("saveBtn")[0] as HTMLButtonElement;
    const cancelBtn = row.getElementsByClassName("canBtn")[0] as HTMLButtonElement;
    const deleteBtn = row.getElementsByClassName("delBtn")[0] as HTMLButtonElement;
  ...
  saveUser(event: Event) {
    ...
    saveBtn.style.display = "none";
    const editBtn = row.getElementsByClassName("edtBtn")[0] as HTMLButtonElement;
    const deleteBtn = row.getElementsByClassName("delBtn")[0] as HTMLButtonElement;
    const cancelBtn = row.getElementsByClassName("canBtn")[0] as HTMLButtonElement;
